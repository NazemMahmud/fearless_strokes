...
$sql = mysqli_fetch_row(mysqli_query($con, "SELECT category_name,category_description  from hj_category_info where category_id='".$cat_id."' "));


$product_id = $_REQUEST["Productid"];
$sql_product = mysqli_fetch_row(mysqli_query($con, "SELECT ProductID,ProductName,Description, orderid,ActiveStatus,Price,SerialNo
...
<!--
$sql = mysqli_fetch_row(mysqli_query($con, "SELECT category_name,category_description  from hj_category_info where category_id='".$cat_id."' "));
$sql_product = mysqli_fetch_row(mysqli_query($con, "SELECT ProductID,ProductName,Description, orderid,ActiveStatus,Price,SerialNo  FROM hj_product_info

$sql_productfullid = mysqli_query($con, "SELECT ProductFullID,SerialNo,Qty FROM hj_product_details

$sqlimage = mysqli_fetch_row(mysqli_query($con, "SELECT ImageID, ProductID,BigImage,MidImage,SmallImage,SerialNo FROM hj_product_image
-->
                <div id="view-thumb">
                    <img id="theImg" class="my-foto img-responsive" src="productimage/hj/<?php echo $sqlimage[2]?>" data-large="productimage/hj/<?php echo $sqlimage[2]?>" title="">
                </div>
            </div>
           	...
           	<div class="col-md-7 col-sm-6">
            	 <div class="productHeader container-fluid">
                    <div class="row">
                        ...
                        <div class="col-sm-4">
                            <!--<div class="price">-->
              <p style="padding-top: 26px; padding-right:10px; font-family: Helvetica; color:#999; font-size:17px;" class="pull-right">Tk <?php echo $sql_product[5]?></p>                                    
                           <!-- </div>-->
                ...
                <div class="row">
                	<div class="col-sm-6 col-sm-offset-3">
                    	<form action="" method="">
                            ...
                            <a class="btn btn-success btn-block" id="bagadd" onclick="return all_check('addhj', '<?php echo $product_id;?>');"><i class="fa fa-cart-plus"></i> Add To Bag</a>
                            ...
                            <div class="tabbable-line">
                                ...
                                <div class="tab-content">
                                    ...
                                    <div class="tab-pane" id="tab_default_2">
                                        ...
                                        <p>
                                            <?php 
                                           $desc =  mysqli_fetch_row(mysqli_query($con, "SELECT Category_name,category_description  from hj_category_info where category_id='".$cat_id."' "));
                                            echo $desc[1];?>
                                        </p>
                                    </div>
                                </div>
