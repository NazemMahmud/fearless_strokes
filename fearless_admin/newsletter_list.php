	     ...
	     if(isset($_REQUEST["del"]) && $_REQUEST["del"]=="ok")
		  {
				...
				$del_news_letter=mysqli_query($con, "DELETE  FROM newsletter_info WHERE NewsLetterID='".$_REQUEST["NewsLetterID"]."'");
			      header("Location:newsletter_list.php?msg=Successfully Deleted Newsletter..");
		  }
	
      $TotalPage=mysqli_query($con, "SELECT COUNT(NewsLetterID) FROM newsletter_info");
...
{
   //alert(""+id);
	var result = confirm("Are you sure you want to Delete this Newsletter?");
	if (result==true)
	{
		window.location = "newsletter_list.php?del=ok&NewsLetterID="+id;
	}
}
</script>
         <style type="text/css">
		...
		<div id="right">
				...
				<div class="box" style="background:none;">
					...
					<div class="title" style="margin-bottom:0px;">
						<h5><?php print @isset($_REQUEST["msg"])?$_REQUEST["msg"]:"NewsLetter List"; ?></h5>
					</div>
					<!-- end box / title -->
	...
	<span>Total Newsletter: <?php print $sss[0]; ?></span>
	</div>
	</div>						
  ...
  <table width="413" border="0" align="left" cellpadding="0" cellspacing="0">
        <thead>
            <tr >
              ...
              <th width="313" align="center"  ><strong> Title </strong></th>
              <th width="204" align="center"  ><strong>Category</strong></th>
...
ORDER BY newsletter_info.NewsLetterID DESC LIMIT $count,25");
            ...
            <tr <?php print $bgcolor; ?>>
			  ...
			  <?php
							 ...
							 if($check_access=="yes")
							  {
							 ?>
			  <a href="edit_newsletter.php?NLID=<?php print $row[0]; ?>">Edit</a>
			  <br>
			  <?php } ?>
			  <?php
			  ...
			  <?php
							 ...
							 if($check_access=="yes")
							  {
							 ?>
			  <a href="send_newsletter.php?NLID=<?php print $row[0]; ?>">Send</a>
			          <?php } ?>
        ...
        <?php
         ...
         for($i=$pre;$i<=$nxt+1;$i++)
		 {
		  ...
		  {
		  ?>
		  <li><a href="newsletter_list.php?recpos=1">Start</a></li>
		  <li><a href="newsletter_list.php?recpos=<?php print $i-1; ?>" ><< prev</a></li>
		  <?php } ?>
		  <?php
		...
		?>
		  ...
		  <li><a href="newsletter_list.php?recpos=<?php print $i; ?>">next >></a></li>
     <?php }
	    if($li<=7 && $i>0)
	      { 
		  ...
		  <li><a href="newsletter_list.php?recpos=<?php print $i; ?>"><?php print $i; ?></a></li>
		<?php }}
		...
		<li><a href="newsletter_list.php?recpos=<?php print $TotalPageRow; ?>">End</a></li>
		<?php } ?>
		</ul>
