	...
	if(isset($_POST["btnAdd"]))
	  {
		 ...
		 if(mysqli_query($con, "INSERT INTO promotional_code (PromotionalID,Discount,Description,ActiveStatus)
		  VALUES('".$_POST["CategoryName"]."','".$_POST["Discount"]."','".$_POST["CategoryDescription"]."','Active')"))
		 {
			header("Location:promotion_list.php?msg=Successfully Add Promotion Code");	 
		 }
		 else
		 {
			header("Location:insert_promotion.php?msg=Insertion Failed! Try Again");	  
		 }
	...
	<body>
		...
		<div id="right">
				...
				<div class="box">
					<!-- box / title -->
					<div class="title">
						<h5><?php print isset($_REQUEST['msg'])?$_REQUEST['msg']:"Insert Promotional Code"; ?></h5>
						<div class="search">
					...
					<form action="<?php print $_SERVER['PHP_SELF'] ?>" name="customer" method="post" enctype="multipart/form-data">
						...
						<div class="fields">
                            ...
                            <div class="field">
								...
								<div class="input">
									<input id="Discount" name="Discount"  class="small valid" type="text">
								</div>
							</div>
					  <div class="field">
								<div class="label">
