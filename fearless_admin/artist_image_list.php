...
//    $Date=MakeDate();
    if(isset($_REQUEST["del"]) && $_REQUEST["del"]=="ok")
    {
        ...
        $id = $_GET["artistid"];
        $result = mysqli_query($con, "SELECT images FROM artist_detail WHERE artist_id='".$id."'");
        $image=mysqli_fetch_row($result);
        @unlink('../uploads/'.$image[0]);
        $sql="DELETE FROM artist_detail WHERE artist_id='".$id."'";
        $result=mysqli_query($con, $sql);
        header("Location:artist_image_list.php?id=".$id."msg=Successfully Deleted!");
...
<!--                      <td width="109" align="center"  ><strong>E-mail</strong></td>-->
                ...
                $sl=0;
                  $rs=mysqli_query($con, "SELECT artist_detail.id, 
                  artist.artist_name, 
                ...
                ?>
                    <tr valign="middle" <?php print $bgcolor; ?>>
                      ...
                      <?php
                          ...
                          <a style="" href="artist_email?id=<?php echo $row[0]; ?>&ac=y" >Accept</a>&nbsp;&nbsp;
                          <a style="" href="artist_email?id=<?php echo $row[0]; ?>&ac=n" >Reject</a>&nbsp;&nbsp;
