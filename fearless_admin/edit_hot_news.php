	...
	<body>
		...
		<div id="right">
				...
				<div class="box">
					<!-- box / title -->
					<div class="title">
						<h5><?php print isset($_REQUEST['msg'])?$_REQUEST['msg']:"Edit Hot News "; ?></h5>
						<div class="search">
				...
				<iframe src="editor/edit_hot_news.php?HotNewsID=<?php print $_REQUEST["HotNewsID"] ?>" height="500" width="100%" style="background:#FFFFFF;"></iframe>
			  </div>
		  </div>
				<!-- end table --><!-- messages -->
