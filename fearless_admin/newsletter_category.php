	...
	if(isset($_POST["btnAdd"]))
	  {
		 ...
		 $CatID=MakeID($con, "newslatter_category","CategoryID","NLCAT-",10);
			$rs=mysqli_query($con, "INSERT INTO newslatter_category
			(CategoryID,
			CategoryName,
			CategoryDescription,
			ActiveStatus)
			...
			'Active')");
			 ...
			 header("Location:newsletter_category_list.php?msg=Successfully Add NewsLetter Category");	
	  }
	...
	<body>
		...
		<div id="right">
				...
				<div class="box">
					<!-- box / title -->
					<div class="title">
						<h5><?php print isset($_REQUEST['msg'])?$_REQUEST['msg']:"Insert NewsLetter Category"; ?></h5>
						<div class="search">
