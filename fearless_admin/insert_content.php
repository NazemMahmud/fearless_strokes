	...
	<body>
		...
		<div id="right">
				...
				<div class="box">
					<!-- box / title -->
					<div class="title">
						<h5><?php print isset($_REQUEST['msg'])?$_REQUEST['msg']:"Insert Article"; ?></h5>
						<div class="search">
				...
				<iframe src="editor/insert_content.php" height="610" width="100%" style="background:#FFFFFF;"></iframe>
			  </div>
		  </div>
				<!-- end table --><!-- messages -->
