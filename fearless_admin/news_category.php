	...
	if(isset($_POST["btnAdd"]))
	  {
		 ...
		 $CatID=MakeID($con, "news_category_info","CategoryID","NCAT-",10);
			$rs=mysqli_query($con, "INSERT INTO news_category_info
			(CategoryID,
			CategoryName,
			CategoryDescrition,
			ActiveStatus)
			...
			'Active')");
			 ...
			 header("Location:news_category_list.php?msg=Successfully Add Category");	
	  }
	...
	<body>
		...
		<div id="right">
				...
				<div class="box">
					<!-- box / title -->
					<div class="title">
						<h5><?php print isset($_REQUEST['msg'])?$_REQUEST['msg']:"Insert Notice & Circulation Category"; ?></h5>
						<div class="search">
