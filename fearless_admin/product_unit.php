	...
	if(isset($_POST["btnAdd"]))
	  {
		...
		$unitname = mysqli_real_escape_string($con, $unitname) ;
		 ...
		 $UnitID=MakeID($con, "product_unit","UnitID","",2);
			$rs=mysqli_query($con, "INSERT INTO product_unit (UnitID,UnitName,Description,ActiveStatus)
			 VALUES('".$UnitID."','".$unitname."','".$_POST["CategoryDescription"]."','Active')");
			
			
			
			 header("Location:product_unit_list.php?msg=Successfully Inserted Product Unit");	
	  }
	...
	<body>
		...
		<div id="right">
				...
				<div class="box">
					<!-- box / title -->
					<div class="title">
						<h5><?php print isset($_REQUEST['msg'])?$_REQUEST['msg']:"Insert Product Size"; ?></h5>
						<div class="search">
					...
					<form action="<?php print $_SERVER['PHP_SELF'] ?>" name="customer" method="post" enctype="multipart/form-data">
						...
						<div class="fields">
							...
							<div class="field">
								<div class="label">
									<label for="input-medium">Size  Name:</label>
								</div>
								<div class="input">
