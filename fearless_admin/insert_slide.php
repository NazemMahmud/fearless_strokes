	...
	if(isset($_POST["btnAdd"]))
	  {
		 ...
		 if($_REQUEST["Menu"]=="")
		 {
		   header("Location:insert_slide.php?msg=Please Select A Menu");
		 }
		 $SlideID=MakeID($con, "slide_info","SlideID","SLD-",8);
		...
		$fileext = strtolower(substr($uploadfilename,strrpos($uploadfilename,".")+1));
			...
			{ 
			header("Location:insert_slide.php?msg=Add New Image");
			die();		
		    }
			...
			$rs=mysqli_query($con, "INSERT INTO slide_info 
			(SlideID,
			Title,
			SubTitle,
			ActiveStatus,
			Image
			) VALUES('".$SlideID."','".$_POST["Title"]."','".$_POST["SubTitle"]."','InActive','".$file1."')");
			
			 header("Location:slide_list.php?msg=Successfully Add Slide");
			 }	
			 else
			 {
			 header("Location:insert_slide.php?msg=Upload A Slide Image");
			 }
	  }
	...
	<body>
		...
		<div id="right">
				...
				<div class="box">
					<!-- box / title -->
					<div class="title">
						<h5><?php print isset($_REQUEST['msg'])?$_REQUEST['msg']:"Insert Slide"; ?></h5>
						<div class="search">
					...
					<form action="<?php print $_SERVER['PHP_SELF'] ?>" name="customer" method="post" enctype="multipart/form-data">
						...
						<div class="fields">
							...
							<div class="field">
								...
								<div class="input">
									<input id="Title" name="Title"  class="small valid" type="text">
								</div>
							</div>
					  <div class="field">
								<div class="label">
								...
								<div class="input">
								  <textarea name="SubTitle" cols="21" rows="2" id="SubTitle" ></textarea>
						  </div>
							</div>
							<div class="field">
								<div class="label">
