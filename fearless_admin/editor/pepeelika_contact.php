...
{	
			...
			$sql="UPDATE contact_info SET name='".$_POST["name"]."',description='".$_POST['designdetail']."' WHERE id='1'";
			
			$update=mysqli_query($con, "$sql"); 
			if($update)
			 {
			  print "<script>alert('Address Successfully Updated')</script>";
			 }
			else
			 if($update)
			 {
...
////////////////////////////////		
 ...
 $rs=mysqli_query($con, "SELECT * FROM contact_info WHERE id='1'"); 
...
<table width="703" border="0" align="center" cellpadding="0" cellspacing="0">
  ...
  <tr>
    <td width="171" height="19" align="left" valign="top"><strong>Contact Address :</strong></td>
