	...
	if(isset($_POST["btnAdd"]))
	  {
		 ...
		 if($_POST["ProductCategory"]!="" && $_POST["ProductSubCategoryID"]!="")
		 {
		   $CatID=MakeID($con, "product_ssub_category","SubSubCategoryID","",3);
		   ...
		   $fileext = strtolower(substr($uploadfilename,strrpos($uploadfilename,".")+1));
			...
			{ 
			header("Location:product_sub_sub_category.php?msg=Add New Icon");
			die();		
		    }
			...
			$rs=mysqli_query($con, "INSERT INTO product_ssub_category (SubSubCategoryID,SubCategoryID,SubCategoryName,Description,ActiveStatus,IconName)
               VALUES('".$CatID."','".$_POST["ProductSubCategoryID"]."','".$_POST["CategoryName"]."',
			   '".$_POST["CategoryDescription"]."','Active','".$bigimg."')");
			
	header("Location:product_list2.php?msg=Successfully Inserted Sub Sub Category&SubCategoryID=".$_POST["ProductSubCategoryID"]."");	
	die();	
		 }
		 else
		 {
		   header("Location:product_sub_sub_category.php?msg=Please Select Both Product Category and Sub Category");
		   die();	 
		 }
	  }
	...
	<body>
		...
		<div id="right">
				...
				<div class="box">
					<!-- box / title -->
					<div class="title">
						<h5><?php print isset($_REQUEST['msg'])?$_REQUEST['msg']:"Insert Product Sub Sub Category"; ?></h5>
						<div class="search">
					...
					<form action="<?php print $_SERVER['PHP_SELF'] ?>" name="customer" method="post" enctype="multipart/form-data">
						...
						<div class="fields">
							...
							<div class="field">
								<div class="label">
									<label for="input-medium">Sub Sub Category  Name:</label>
								</div>
								<div class="input">
