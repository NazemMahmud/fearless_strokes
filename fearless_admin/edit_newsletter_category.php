...
//			'Active')");
			$rs=mysqli_query($con, "UPDATE newslatter_category SET 
			...
			ActiveStatus='".$_POST["ActiveStatus"]."'
			 ...
			 header("Location:newsletter_category_list.php?msg=Successfully Edit NewsLetter Category");	
	  }
	  $rs=mysqli_query($con, "SELECT * FROM newslatter_category WHERE CategoryID='".$_REQUEST["CategoryID"]."'");
	...
	<body>
		...
		<div id="right">
				...
				<div class="box">
					<!-- box / title -->
					<div class="title">
						<h5><?php print isset($_REQUEST['msg'])?$_REQUEST['msg']:"Edit NewsLetter Category"; ?></h5>
						<div class="search">
