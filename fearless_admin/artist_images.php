...
if(isset($_REQUEST["del"]) && $_REQUEST["del"]=="ok")
{
    ...
    $id = $_GET["artistid"];
    $result = mysqli_query($con, "SELECT images FROM artist_image_details WHERE artist_id='".$id."'");
    $image=mysqli_fetch_row($result);
    @unlink('../artist_images/'.$image[0]);
    $sql="DELETE FROM artist_image_details WHERE artist_id='".$id."'";
    $result=mysqli_query($con, $sql);
    header("Location:artist_images.php?id=".$id."msg=Successfully Deleted!");
...
//           alert(""+id);
            ...
            if (result == true) {
//                alert(""+id);
                window.location = "artist_image_list.php?del=ok&artistid=" + id;
            }
        }
    </script>
    <style type="text/css">
...
<div id="content">
    ...
    <div id="right">
        ...
        <div class="box" style="background:none;">
            <!-- box / title -->
            <div class="title">
                <h5><?php print @isset($_REQUEST["msg"])?$_REQUEST["msg"]:"Artist Image List"; ?></h5>
            </div>
            <!-- end box / title -->
            ...
            <form action="<?php print $_SERVER['PHP_SELF'] ?>" name="customer" method="post" enctype="multipart/form-data"><br>
                <table width="728" border="0" align="left" cellpadding="0" cellspacing="0">
                    <tr >
                        ...
                        <td width="103" align="center"  ><strong>Artist Name </strong></td>
                        <td width="103" align="center"  ><strong> Image Title </strong></td>
                        <td width="119" align="center" ><strong>Image</strong></td>
                        <!--                      <td width="125" align="center"  ><strong>Contact</strong></td>-->
                    ...
                    $sl=0;
                    $rs=mysqli_query($con, "SELECT artist_image_details.id, 
                  artist.artist_name, 
                  artist_image_details.image_title,
                  artist_image_details.images,
                  artist_image_details.active,
                  artist.id	
                    FROM artist_image_details INNER JOIN artist ON (artist_image_details.artist_id=artist.id)
                    ORDER BY artist_image_details.id ");
...
//                    for artist image active inactive permission for approval
                        if($row[4]==1)
                        {$acinac="Reject";}
                        else
                        {$acinac="Accept";}
                        ...
                        <tr valign="middle" <?php print $bgcolor; ?>>
                            ...
                            <td align="center"><img src="../<?php print $row[3]; ?>" width="100" data-toggle="modal" data-target="#myModal<?php echo $row[5]?>"></td>
                            ...
                            <td align="center">
                                ...
                                if($check_access=="yes")
                                {
                                    ...
                                    &nbsp;
                                    <a  href="#" onclick="ConfirmDelete('<?php print $row[5] ?>','none');">Delete</a>&nbsp;&nbsp;
                      ...
                      Permission Set
                        ...
                        <!-- Modal -->
                        <div class="modal fade" id="myModal<?php echo $row[5]?>" role="dialog">
                            <div class="modal-dialog modal-lg">
                                ...
                                <div class="modal-content">
                                    ...
                                    <div class="modal-body" style="text-align: center">
                                        <!--                                      <p>--><?php //echo $row[1]?><!--</p>-->
                                        <img src="../<?php print $row[3]; ?>" width="400" >
                                    </div>
