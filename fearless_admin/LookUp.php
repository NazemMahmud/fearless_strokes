...
case "SSUBCAT":
  ...
  case "PDTSUBCAT":
			...
			$cat = mysqli_fetch_row(mysqli_query($con, "SELECT CategoryID FROM product_sub_category WHERE SubCategoryID='".$srcText."'"));
  ...
  case "ADDMORE":
				 ...
				 $color_rs = mysqli_query($con, "SELECT ColorID,ColorName FROM color_list");
					...
					$VALUE .="(1)&nbsp;<input required type='file' class='fileToUpload'  name='$file1' id='$file1' />&nbsp;<label>not less than 1200*1583 and not more than 1481*1900</label>";
...
//					$VALUE .="(4)&nbsp;<input type='file'  name='$file4' id='$file4'/>&nbsp;";
	...
	$VALUE .="<div><div style='width:100px;'><span>$size_row[1]&nbsp;";
