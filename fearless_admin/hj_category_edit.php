	...
	if(isset($_POST["btnEdit"]))
	  {
			...
			$rs=mysqli_query($con, "UPDATE hj_category_info SET 
			 ...
			 header("Location:hj_product_list.php?msg=Successfully Edit Product Category");	
	  }
	  $rs=mysqli_query($con, "SELECT * FROM hj_category_info WHERE category_id='".$_REQUEST["CategoryID"]."'");
	...
	<body>
		...
		<div id="right">
				...
				<div class="box">
					<!-- box / title -->
					<div class="title">
						<h5><?php print isset($_REQUEST['msg'])?$_REQUEST['msg']:"Edit Home Junction Product Category"; ?></h5>
						<div class="search">
...
<!--					category_id,category_name,category_description image orderid   -->
						...
						<div class="fields">
							<div class="field">
								...
								<div class="input">
                                    ...
                                    <input id="bigimg" name="bigimg" type="hidden" value="<?php print $row[3]; ?>">
								</div>
							</div>
							<div class="field">
								<div class="label">
							...
							?>
							 <div class="field">
							  ...
							  <div class="select">
							    <img src="../menuimage/homejunction/<?php print $row[3]; ?>" />
							  </div>
							...
							<div class="field">
                                ...
                                <div class="select"> 
                                    <input name="uploadimage" type="file" id="uploadimage" class="fileToUpload" /> <label for="input-valid"><strong>resolution must be (304 x 304)</strong></label>
                                </div>
                ...
                $(".fileToUpload").change(function(e) {
                    ...
                    if ((fileToUpload = this.files[0])) {
                        ...
                        image.onload = function() {
                            // alert("sdasd");
                            if(this.width!=304 || this.height!=304){
                                $(".fileToUpload").val('');
                                alert("The image size must be 304 X 304");
