	...
	if(isset($_POST["btnAdd"]))
	  {
		   ...
		   if($_POST["billingAreaName"]!="")
		   {
		     $UnionID=MakeID($con, "union_info","UnionID","UNON-",10);
			  $rs=mysqli_query($con, "INSERT INTO union_info (UnionID,ThanaID,Name,Description,ActiveStatus) 
			  VALUES('".$UnionID."','".$_POST["billingAreaName"]."',
			  '".htmlspecialchars($_POST["UnionName"],ENT_QUOTES)."',
			  '".htmlspecialchars($_POST["ShortDescription"],ENT_QUOTES)."',
			  'InActive')");
             header("Location:union_list.php?msg=Successfully Add Union/Sector Name");
		   }
		   else
		   {
		      header("Location:insert_union.php?msg=Please Enter a Union/Sector Name");
		   }
	...
	<body>
		...
		<div id="right">
				...
				<div class="box">
					<!-- box / title -->
					<div class="title">
						<h5><?php print isset($_REQUEST['msg'])?$_REQUEST['msg']:"Insert Union/Sector Station"; ?></h5>
						<div class="search">
						...
						<div class="fields">
							...
							<div class="field">
							  <div class="label">
								...
								<div class="input" >
                                 <input name="UnionName" id="UnionName" type="text" class="small valid" size="20"  />
								</div>
							</div>
							<div class="field">
								<div class="label">
								...
								<div class="input">
								  <textarea name="ShortDescription" cols="22"></textarea>
								</div>
							</div>
							<div class="buttons">
