	...
	<body>
		...
		<div id="right">
				...
				<div class="box">
					<!-- box / title -->
					<div class="title">
						<h5><?php print isset($_REQUEST['msg'])?$_REQUEST['msg']:"Edit NewsLetter "; ?></h5>
						<div class="search">
				...
				<iframe src="editor/edit_newsletter.php?NLID=<?php print $_REQUEST["NLID"]; ?>" height="500" width="100%" style="background:#FFFFFF;"></iframe>
			  </div>
		  </div>
				<!-- end table --><!-- messages -->
