	...
	<body>
		...
		<div id="right">
				...
				<div class="box">
					<!-- box / title -->
					<div class="title">
						<h5><?php print isset($_REQUEST['msg'])?$_REQUEST['msg']:"Edit Notice and Circulation "; ?></h5>
						<div class="search">
				...
				<iframe src="editor/news_edit.php?NID=<?php print $_REQUEST["NewsID"] ?>" height="300" width="100%" style="background:#FFFFFF;"></iframe>
			  </div>
		  </div>
				<!-- end table --><!-- messages -->
