...
function ConfirmAcInac(id)
{
		...
		<div id="right">
				...
				<div class="box" style="background:none;">
					...
					<div class="title" style="margin-bottom:0px;">
						<h5><?php print @isset($_REQUEST["msg"])?$_REQUEST["msg"]:"Category List for Viewing Product Sub Category"; ?></h5>
					</div>
					<!-- end box / title -->
  ...
  <table width="413" border="0" align="left" cellpadding="0" cellspacing="0">
       <thead>
            <tr >
              <th align="left" ><strong> Product Sub Category </strong></th>
            </tr>
		</thead>
		<tbody>
       		<?php
				...
				$sl=0;	
              $rs=mysqli_query($con, "SELECT CategoryID,CategoryName FROM product_category_info ORDER BY orderid");
            ...
            <tr >
			  ...
			  <strong><?php print $row[1] ?></strong>
			   <?php
			    $sub=mysqli_query($con, "SELECT SubCategoryID,SubCategoryName FROM product_sub_category WHERE CategoryID='".$row[0] ."' ORDER BY orderid ");
			    while($subRow=mysqli_fetch_row($sub))
				{
			   ?>
			    <br><br>&nbsp;&nbsp;&nbsp;
			   <strong><a href="product_sub_sub_category_list.php?SubCategoryID=<?php print $subRow[0] ?>"><?php print $subRow[1] ?></a></strong>
			   <?php } ?>
			  </td>
            </tr>
              <?php } ?>
