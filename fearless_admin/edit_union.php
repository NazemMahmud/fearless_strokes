	...
	if(isset($_POST["btnEdit"]))
	  {
		  ...
		  $UnionID=$_REQUEST["UnionID"];
			  $update=mysqli_query($con, "UPDATE union_info SET ThanaID='".$_POST["ThanaName"]."',
			  Name='".htmlspecialchars($_POST["UnionName"],ENT_QUOTES)."',
			  Description='".htmlspecialchars($_POST["ShortDescription"],ENT_QUOTES)."' WHERE UnionID='".$UnionID."'");
             header("Location:edit_union.php?msg=Successfully Updated Union/Sector Name...&UnionID=$UnionID");

			
	
	  }
     $row=mysqli_fetch_row(mysqli_query($con, "SELECT * FROM union_info WHERE UnionID='".$_REQUEST["UnionID"]."'"));			
?>
	...
	<body>
		...
		<div id="right">
				...
				<div class="box">
					<!-- box / title -->
					<div class="title">
						<h5><?php print isset($_REQUEST['msg'])?$_REQUEST['msg']:"Edit Union/Sector Station"; ?></h5>
						<div class="search">
						...
						<div class="fields">
					        ...
					        <div class="field">
							  ...
							  <div class="input" id="thana">
								  <select name="ThanaName" id="ThanaName">
                                   
                                     <?php
									  $rs=mysqli_query($con, "SELECT ThanaID,ThanaName FROM thana_info WHERE ActiveStatus='Active' ORDER BY ThanaName");
								  ...
								  <input type="hidden" name="UnionID" id="UnionID" value="<?php print $row[0]; ?>" />
								</div>
							</div>
							<div class="field">
							  <div class="label">
								...
								<div class="input" >
                                 <input name="UnionName" id="UnionName" type="text" class="small valid" value="<?php print $row[2]; ?>" size="20"  />
								</div>
							</div>
							<div class="field">
								<div class="label">
