          	...
          	<?php include('category_left_menu_hj.php');?>
           	...
           	<div class="col-md-9">
              	<div class="col-sm-12 creative">
                    <?php
                        $sql = mysqli_fetch_row(mysqli_query($con, "SELECT category_id,category_name,category_description FROM hj_category_info WHERE category_id='".$_REQUEST["id"]." ' "));
                    ?>
...
<!--                   	</div>-->
                    ...
                    <div id="products" class="list-group">
                        <?php //ProductID,ProductName,Features, orderid,ActiveStatus,Price,ShippingCost,SerialNo
                            $sql=mysqli_query($con, "SELECT ProductID,ProductName,Description, orderid,ActiveStatus,Price,SerialNo
                        ...
                        <a href="product_hj_details.php?CatId=<?php echo $id;?>&Productid=<?php echo $row[0]; ?>&Serial=<?php echo $row[6]; ?>"> 
                            <div class="item col-md-4  col-xs-12 col-lg-4">
                                <div class="thumbnail">
                                    <img class="group list-group-image" src="productimage/hj/<?php echo $sqlimage[3]?>" alt="<?php echo $sqlimage[1]?>" />
                                    <div class="caption">
